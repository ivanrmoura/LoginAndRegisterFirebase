...
import br.com.ivan.loginfirebaseexempler.di.UsersCollection
import br.com.ivan.loginfirebaseexempler.model.User
import br.com.ivan.loginfirebaseexempler.utils.Constants.Companion.USER_LOGGED_IN_ID
...
class FirebaseAuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun login(email: String, password: String): Flow<NetworkResult<Boolean>> {
        return flow {
            ...
            try {
               val userLogado =  firebaseAuth.signInWithEmailAndPassword(email, password)
                    .await()
