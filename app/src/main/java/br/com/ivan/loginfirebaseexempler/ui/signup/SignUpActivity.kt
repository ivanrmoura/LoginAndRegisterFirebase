...
import br.com.ivan.loginfirebaseexempler.databinding.ActivitySignupBinding
import br.com.ivan.loginfirebaseexempler.model.User
import br.com.ivan.loginfirebaseexempler.utils.Constants.Companion.EMAIL_ALREADY_EXISTS
import br.com.ivan.loginfirebaseexempler.utils.NetworkResult
import br.com.ivan.loginfirebaseexempler.utils.isInputEmpty
...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun initObservers(){
        ...
        signUpViewModel.saveUserState.observe(this, Observer { result->
            when(result){
                is NetworkResult.Sucess -> {
                    toast(getString(R.string.signup__signup_successfully))
                    binding.progressSignup.visibility = View.GONE
                    finish()
                }
                is NetworkResult.Error ->{
